...
unsigned int nTargetSpacing = 1 * 30; // Wozniak - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // Wozniak - time to elapse before new modifier is computed
...
const string strMessageMagic = "Wozniak Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Wozniak", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.com/news/world-africa-38427469";
        CTransaction txNew;
        txNew.nTime = 1482613123;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1482613123;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6449382;
        ...
        assert(block.hashMerkleRoot == uint256("0xb8f3a8c20ae837257cccb686b3885352dbbfaf7db2fe9634ab0606b8e4ba8bd1"));
