...
private slots:
    ...
    void on_Buywoz_clicked();
    void on_SellwozBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputwoz_textChanged(const QString &arg1);
    ...
    QString Buywoz(QString OrderType, double Quantity, double Rate);
    QString Sellwoz(QString OrderType, double Quantity, double Rate);
