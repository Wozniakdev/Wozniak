...
!define URL http://www.Wozniak.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Wozniak.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Wozniak-qt.exe
...
OutFile Wozniak-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Wozniak-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Wozniakd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Wozniak.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Wozniak-qt.exe
